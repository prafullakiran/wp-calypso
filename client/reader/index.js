...
module.exports = function() {
	if ( config.isEnabled( 'reader' ) ) {
		page( '/', controller.preloadFullPost, controller.loadSubscriptions, controller.checkForColdStart, controller.initAbTests, controller.updateLastRoute, controller.removePost, controller.sidebar, controller.following );
